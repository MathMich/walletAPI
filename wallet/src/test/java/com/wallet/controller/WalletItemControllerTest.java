...
public class WalletItemControllerTest {
	...
	public void testUpdate() throws Exception {
		...
		Wallet w = new Wallet();
		w.setId(ID);
		//                                                               Option pois é um retorno que pode ter ou não
	...
	// Não vamos permitir que usuário altere a carteira
	@Test
	@WithMockUser
	...
	public String getJsonPayLoad() throws JsonProcessingException {
		...
		// Usa ObJectMaper pra retornar uma String no formato JSON
